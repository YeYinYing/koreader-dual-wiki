...
Install from the KOReader AppStore (`appstore.koplugin`), or download `koreader-dual-wiki-v1.3.0.zip` from the [Releases](../../releases) page and extract it to `koreader/plugins/`:

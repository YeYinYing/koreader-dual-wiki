...
local PLUGIN_VERSION = "1.3.5" -- luacheck: ignore 211
...
-- Three-layer split (v1.4.0): pipeline side-effect boundary. Helpers stay
-- inline above for -- [[ query-helpers ]] marker compatibility; the
-- network/candidate ladder lives in pipeline.lua and is re-exported below
-- via Facade so DualWiki.queryPipeline/fetchCandidates/fetchDirect signatures
-- stay 100% invariant for 1837-line automation.
